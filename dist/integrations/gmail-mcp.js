...
exports.GmailMcpBot = void 0;
exports.createGmailMcpBot = createGmailMcpBot;
const __1 = require("..");
const googleapis_1 = require("googleapis");
class GmailMcpBot extends __1.OrganiselyBot {
    gmail = googleapis_1.google.gmail('v1');
    auth;
    oauth2Config;
    constructor(config) {
        super();
    ...
    setTokens(accessToken, refreshToken) {
        this.auth = new googleapis_1.google.auth.OAuth2(this.oauth2Config.clientId, this.oauth2Config.clientSecret, this.oauth2Config.redirectUri);
        this.auth.setCredentials({
            access_token: accessToken,
            refresh_token: refreshToken
        });
        // Set the auth for googleapis
        googleapis_1.google.options({ auth: this.auth });
    }
    ...
    async executeGmailSearch(params) {
    ...
    async executeGmailReadMessage(params) {
    ...
    async executeGmailListMessages(params) {
    ...
    async executeGmailSendMessage(params) {
    ...
    async executeGmailListLabels(params) {
        try {
    ...
    async listMessages(labelIds = ['INBOX'], maxResults = 10) {
...
exports.GmailMcpBot = GmailMcpBot;
function createGmailMcpBot(config) {
